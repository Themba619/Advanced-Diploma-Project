...
const getUserProfileData = (req, res) => {
  try {
    ...
    if (userProfile.profileImage) {
      const imagePath = path.join(__dirname, '../public/profile-images', userProfile.profileImage);
    ...
    res.json({
      ...
      profileData: {
        ...
        imageUrl: userProfile.profileImage ? `/profile-images/${userProfile.profileImage}` : null,
